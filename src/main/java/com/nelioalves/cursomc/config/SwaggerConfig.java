...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Sistema de Pedidos",
				"Esta API é utilizada para o sistema de pedidos", 
				"Versão 1.0",
				"https://www.sis7.com.br/terms",
				new Contact("Giovanni Amorim", "www.sis7.com.br", "giovanni.amorim.ti@gmail.com"),
				"Sistema de Pedidos", "https://www.sis7.com.br/termos", Collections.emptyList() // Vendor
																										// Extensions
		);
	}
